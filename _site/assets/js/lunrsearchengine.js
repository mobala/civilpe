...
var documents = [{
    ...
    "id": 6,
    "url": "http://localhost:4000/Design-of-Non-Structural-Components/",
    "title": "Seismic Design of Non Structural Components per ASCE 7",
    "body": "2019/11/09 - In this video I provide an example of how to calculate the seismic force on a non structural component as perscribed in ASCE 7-10: "
    }, {
    "id": 7,
    "url": "http://localhost:4000/peseismicquiz/",
    "title": "11 Questions for the PE Seismic Exam",
    "body": "2019/05/12 -  I created an 11 questions quiz which I believe to be representative of some of he questions you might find on the CA PE Seismic Exam. You can access the quiz by clicking here. Enjoy and feel free to reach out to me with any questions. "
    }, {
    "id": 8,
    ...
    "body": "2019/04/27 - A number of months ago a put together a video that goes into the covers the Response Spectrum Method as it is implemented in ASCE 7-10. My aim was to tailor the review to tailor the video to those who are not familiar as to how the method is used in code, and do so through an approach that actually shows the viewer how one can generate their own spectra. For fun, I decided to use data from the El Centro Earthquake to generate my own spectra in an IPython notebook. To download the iPython Notebook shown in this video click here. If you would like to learn more about the Response Spectrum Method, or Earthquake Engineering in general, I would recommend reading Dynamics of Structures by Anil K. Chopra. "
    }, {
    "id": 11,
